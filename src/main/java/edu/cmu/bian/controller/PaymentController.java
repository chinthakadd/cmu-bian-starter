...
public class PaymentController {
    ...
    public String getCardData(@PathVariable String cardNumber) {
        ...
        String url = "https://apimanager.pncapix.com:8243/smartbank-card/1.0.0/1.0.0/card/{cardNumber}";
     HttpsURLConnection.setDefaultHostnameVerifier ((hostname, session) -> true);
        ...
        headers.put("authorization", "Bearer ce0fe2cf-2dc0-3e96-b489-5806070265a0");
